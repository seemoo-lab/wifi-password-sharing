...
class PWSAdvertisement(Advertisement):
    def __init__(self, bus, index, apple_ble_data):
        Advertisement.__init__(self, bus, index, "peripheral")
        self.add_manufacturer_data(0x004C, apple_ble_data)
...
def advertising_main(mainloop, bus, adapter_name, apple_ble_data):
    ...
    test_advertisement = PWSAdvertisement(bus, 0, apple_ble_data)
